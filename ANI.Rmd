...
background-image: url(figs/hemanoel_ani.png)
background-size: 45%
...
```{r out.width='75%'}
knitr::include_graphics("figs/bobay.png")
```
...
background-image: url(figs/hemanoel_grafo.png)
background-size: 40%
background-position: 50% 70%
...
background-image: url(figs/nifH_density.png)
background-size: 75%
background-position: 50% 70%
...
background-image: url(figs/combined_nifh.png)
background-size: 75%
background-position: 50% 70%
...
```{r}
knitr::include_graphics("figs/paper1.png")
```
...
```{r}
knitr::include_graphics("figs/paper2.png")
```
